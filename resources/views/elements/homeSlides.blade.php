@foreach ($topDownloadedMovies as $movie)
<div class="swiper-slide flq-background">
    <div class="flq-background-image">
        <span class="flq-image swiper-image" data-speed=0.7 data-swiper-parallax-x=40%>
            <img src="{{ $movie['background_image_original'] }}" onerror="this.src='https://via.placeholder.com/375X563?text=No%20Image%20Found'" alt="">
        </span>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6 pt-navbar flq-vertical-rhythm">
                @foreach ($movie['genres'] as $genre)
                    <a class="flq-subtitle badge badge-white badge-glass badge-translucent" href="{{ route('movies',array('gernre'=>$genre)) }}" data-animejs> {{ $genre }} </a>
                @endforeach
                <h2 class="display-5 mb-0" data-animejs>{{ $movie['title_english'] }}</h2>
                ...
                <p class="lead" data-animejs>{{ $movie['summary'] }}</p>
                <div class="py-1">
                    <div class="row gy-4 align-items-center">
                        <div class="col-auto" data-animejs>
                            <a href="{{ route('movie',array('id'=>$movie['imdb_code'])) }}" class="btn btn-icon-sm">
