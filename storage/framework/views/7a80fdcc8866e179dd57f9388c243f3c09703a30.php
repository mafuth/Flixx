<?php $__currentLoopData = $topDownloadedMovies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="swiper-slide flq-background">
    <div class="flq-background-image">
        <span class="flq-image swiper-image" data-speed=0.7 data-swiper-parallax-x=40%>
            <img src="<?php echo e($movie['background_image_original']); ?>" onerror="this.src='https://via.placeholder.com/375X563?text=No%20Image%20Found'" alt="">
        </span>
    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-10 col-lg-8 col-xl-6 pt-navbar flq-vertical-rhythm">
                <?php $__currentLoopData = $movie['genres']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="flq-subtitle badge badge-white badge-glass badge-translucent" href="<?php echo e(route('movies',array('gernre'=>$genre))); ?>" data-animejs> <?php echo e($genre); ?> </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <h2 class="display-5 mb-0" data-animejs><?php echo e($movie['title_english']); ?></h2>
                <div class="flq-meta flq-color-opacity mt-3">
                    <ul class="gx-4">
                        ...
                        <li data-animejs>
                            <a href="#"><?php echo e($movie['year']); ?></a>
                        </li>
                    </ul>
                </div>
                <p class="lead" data-animejs><?php echo e($movie['summary']); ?></p>
                <div class="py-1">
                    <div class="row gy-4 align-items-center">
                        <div class="col-auto" data-animejs>
                            <a href="<?php echo e(route('movie',array('id'=>$movie['imdb_code']))); ?>" class="btn btn-icon-sm">
                                <span class="btn-name">Details</span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\mahfaz\Downloads\homeCinema-main\homeCinema-main\resources\views/elements/homeSlides.blade.php ENDPATH**/ ?>