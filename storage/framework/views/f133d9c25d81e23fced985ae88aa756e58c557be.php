...
<div class="py-7 min-vh-100 flq-background d-flex align-items-center">
    <div class="flq-background-image">
        <span class="flq-image jarallax" data-speed=0.7>
            <img src="<?php echo e($movie['background_image_original']); ?>" onerror="this.src='https://via.placeholder.com/375X563?text=No%20Image%20Found'" class="jarallax-img" alt="">
        </span>
    </div>
        ...
        <div class="row gy-6 gx-6">
            <div class="col-12 col-lg-6 col-xl-5 col-xxl-4" data-sr data-sr-duration="1600" data-sr-distance="10">
                <div class="card flq-card-image flq-card-favorites h-lg-100">
                    <a href="<?php echo e($movie['large_cover_image']); ?>" class="card-image" data-fancybox>
                    ...
                    <?php if($movie['yt_trailer_code']): ?>
                        <div class="card-body">
                            <a href="https://www.youtube.com/watch?v=<?php echo e($movie['yt_trailer_code']); ?>" class="btn btn-dark btn-glass btn-block" data-fancybox>
                                <span class="btn-icon">
            ...
            <div class="col-12 col-lg-6 py-lg-2 flq-vertical-rhythm">
                ...
                <?php $__currentLoopData = $movie['genres']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a class="flq-subtitle badge badge-white badge-translucent" href="<?php echo e(route('movies',array('gernre'=>$genre))); ?>" data-sr-item="movie"><?php echo e($genre); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <h1 class="mb-0" data-sr-item="movie"><?php echo e($movie['title_english']); ?></h1>
                <div class="mt-3">
                    <div class="row gy-1 flq-color-opacity">
                        <div class="col-auto" data-sr-item="movie">
                            <div class="d-flex align-items-center">
                                ...
                                <strong class="ms-1 flq-color-title"><?php echo e($movie['rating']); ?></strong>
                            </div>
                        </div>
                        <div class="col-auto" data-sr-item="movie">
                            <a href="#" class="flq-color-meta flq-color-title-hover"><strong><?php echo e($movie['year']); ?></strong></a>
                        </div>
                        <?php if($movie['runtime'] != 0): ?>
                            <div class="col-auto" data-sr-item="movie">
                                <a href="#" class="flq-color-meta flq-color-title-hover"><strong><?php echo e('Around '.round(gmdate("H", $movie['runtime']*60)).' hour long'); ?></strong></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                <p class="lead" data-sr-item="movie"><?php echo e($movie['description_intro']); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="py-7 overflow-hidden flq-background flq-background-color-100">
    ...
    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('torrents',['movie'=>$movie])->html();
} elseif ($_instance->childHasBeenRendered('5lj8Tkk')) {
    $componentId = $_instance->getRenderedChildComponentId('5lj8Tkk');
    $componentTag = $_instance->getRenderedChildComponentTagName('5lj8Tkk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5lj8Tkk');
} else {
    $response = \Livewire\Livewire::mount('torrents',['movie'=>$movie]);
    $html = $response->html();
    $_instance->logRenderedChild('5lj8Tkk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\mahfaz\Downloads\homeCinema-main\homeCinema-main\resources\views/movie.blade.php ENDPATH**/ ?>