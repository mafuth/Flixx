<ul class="nav nav-parent flex-grow-1 flq-navbar-nav justify-content-start d-flex">
    ...
    <li class="nav-item" wire:poll.visible.1s>
        <a href="#" class="nav-link">
            <span class="nav-link-name"><?php echo e($torrentStats['speed']['down']); ?> B/s</span>
        </a>
    </li>
</ul><?php /**PATH C:\Users\mahfaz\Downloads\homeCinema-main\homeCinema-main\resources\views/livewire/torrent-stats.blade.php ENDPATH**/ ?>